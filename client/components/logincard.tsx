...
export function LoginCard() {
  ...
  return (
    <div className="h-[450px] w-[450px] rounded-lg bg-black flex flex-col items-center justify-between px-6 py-4 border border-purple-400 hover:shadow-lg">
      ...
      <div className="flex flex-col rounded-md w-full">
        <form onSubmit={() => {}}>
          ...
          <button
            type="submit"
            className="h-11 flex justify-center items-center bg-white text-black mt-5 rounded-md w-full"
          >
            Login with Email
          </button>
        </form>
      ...
      <button
        ...
        className="h-20 flex justify-center items-center text-white border rounded-md border-emerald-400 w-full"
      >
        Login with Google
      </button>
      <div className="h-10 w-full"></div>
