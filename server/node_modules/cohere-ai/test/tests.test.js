...
(0, globals_1.describe)("test sdk", () => {
    ...
    globals_1.test.concurrent("tool use works", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, globals_1.expect)((_c = toolsResponse.toolCalls) === null || _c === void 0 ? void 0 : _c[0].name).toMatchInlineSnapshot(`"sales_database"`);
        (0, globals_1.expect)((_d = toolsResponse.toolCalls) === null || _d === void 0 ? void 0 : _d[0].parameters).toMatchInlineSnapshot(`
            {
              "day": "2023-09-29",
            }
        `);
        ...
        const toolResults = (_e = toolsResponse.toolCalls) === null || _e === void 0 ? void 0 : _e.map((toolCall) => {
            return {
                call: toolCall,
