...
const _index1 = require("../../storage/index.js");
...
class SummaryIndex extends _BaseIndex.BaseIndex {
    ...
    static async init(options) {
        const storageContext = options.storageContext ?? await (0, _index1.storageContextFromDefaults)({});
    ...
    static async fromDocuments(documents, args = {}) {
        ...
        storageContext = storageContext ?? await (0, _index1.storageContextFromDefaults)({});
    ...
    asQueryEngine(options) {
        ...
        if (!responseSynthesizer) {
            const responseBuilder = new _index2.CompactAndRefine(this.serviceContext);
            responseSynthesizer = new _index2.ResponseSynthesizer({
