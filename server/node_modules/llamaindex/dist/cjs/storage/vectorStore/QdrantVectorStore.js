...
Object.defineProperty(exports, "QdrantVectorStore", {
    enumerable: true,
    get: function() {
...
class QdrantVectorStore {
   ...
   */ constructor({ collectionName, client, url, apiKey, batchSize }){
        ...
        if (client) {
            ...
            this.db = new _jsclientrest.QdrantClient({
                url: url,
                apiKey: apiKey
            });
        }
   ...
   */ async buildPoints(nodes) {
        ...
        for(let i = 0; i < nodes.length; i++){
            ...
            for(let j = 0; j < this.batchSize && i < nodes.length; j++, i++){
                ...
                const metadata = (0, _utils.nodeToMetadata)(node);
   ...
   */ parseToQueryResult(response) {
        ...
        for(let i = 0; i < response.length; i++){
            ...
            const node = (0, _utils.metadataDictToNode)(payload);
            ids.push(item.id);
            nodes.push(node);
